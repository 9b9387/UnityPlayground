...
namespace Owlet
{
    public class GestureRecognizer_OLD : IDisposable
    {
        ...
        public delegate void GestureRecognizerStateUpdatedDelegate(GestureRecognizer_OLD gesture);
        public event GestureRecognizerStateUpdatedDelegate StateUpdated;
        private readonly HashSet<GestureRecognizer_OLD> requireGestureRecognizersToFailThatHaveFailed = new HashSet<GestureRecognizer_OLD>();

        internal static readonly HashSet<GestureRecognizer_OLD> ActiveGestures = new HashSet<GestureRecognizer_OLD>();
        private readonly HashSet<GestureRecognizer_OLD> failGestures = new HashSet<GestureRecognizer_OLD>();
        private readonly HashSet<GestureRecognizer_OLD> requireGestureRecognizersToFail = new HashSet<GestureRecognizer_OLD>();
        ...
        private bool RequiredGesturesToFailAllowsEndPending()
        {
            ...
            {
                using (HashSet<GestureRecognizer_OLD>.Enumerator gestureToFailEnumerator = requireGestureRecognizersToFail.GetEnumerator())
                {
        ...
        private void EndGesture()
        {
            ...
            foreach (GestureRecognizer_OLD gesture in failGestures)
            {
